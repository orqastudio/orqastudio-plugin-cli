...
export declare const DEFAULT_ARTIFACT_LINK_COLORS: Record<string, string>;
 ...
 */
export declare const PLATFORM_RELATIONSHIPS: readonly RelationshipType[];
/**
 * Semantic categories from core.json.
 * Used by checks to query relationship intent without hardcoding keys.
 */
export declare const PLATFORM_SEMANTICS: Record<string, import("./plugin.js").RelationshipSemantic>;
/**
 ...
 */
export declare const PLATFORM_NAVIGATION: readonly NavigationItem[];
